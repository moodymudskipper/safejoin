...
The package *safejoin* features wrappers around pakckages *dplyr* and
*fuzzyjoin*'s functions to join safely using various checks.
...
sides, we can aggregate them into one in flexible ways (including coalesce,
nestn or just keeping one of them). This is done through the `conflict` parameter.
